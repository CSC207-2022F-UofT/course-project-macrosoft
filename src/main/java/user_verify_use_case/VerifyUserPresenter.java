 ...
 */
public class VerifyUserPresenter implements VerifyUserOutputBoundary {
    private VerifyUserScreenInterface verifyUserScreen;

    /**
     * Constructor of VerifyUserPresenter.
     *
     * @param verifyUserScreen a verify user screen
     */
    public VerifyUserPresenter(VerifyUserScreenInterface verifyUserScreen) {
